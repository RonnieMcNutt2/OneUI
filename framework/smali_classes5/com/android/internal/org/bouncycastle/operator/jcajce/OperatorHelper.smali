...
# instance fields
.field private helper:Lcom/android/internal/org/bouncycastle/jcajce/util/JcaJceHelper;
...
.method constructor <init>(Lcom/android/internal/org/bouncycastle/jcajce/util/JcaJceHelper;)V
    .registers 2
...
.method private static getDigestName(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    .registers 5
...
.method private static getSignatureName(Lcom/android/internal/org/bouncycastle/asn1/x509/AlgorithmIdentifier;)Ljava/lang/String;
    .registers 5
...
.method private notDefaultPSSParams(Lcom/android/internal/org/bouncycastle/asn1/ASN1Sequence;)Z
    .registers 8
...
# virtual methods
.method public convertCertificate(Lcom/android/internal/org/bouncycastle/cert/X509CertificateHolder;)Ljava/security/cert/X509Certificate;
    .registers 6
    ...
    :try_end_17
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_17} :catch_36
    .catch Ljava/security/NoSuchProviderException; {:try_start_0 .. :try_end_17} :catch_18
...
.method public convertPublicKey(Lcom/android/internal/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)Ljava/security/PublicKey;
    .registers 6
    ...
    move-result-object v0
    :try_end_21
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_21} :catch_78
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_2 .. :try_end_21} :catch_5c
    .catch Ljava/security/NoSuchProviderException; {:try_start_2 .. :try_end_21} :catch_3e
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_2 .. :try_end_21} :catch_22
...
.method createAlgorithmParameters(Lcom/android/internal/org/bouncycastle/asn1/x509/AlgorithmIdentifier;)Ljava/security/AlgorithmParameters;
    .registers 7
    ...
    move-result-object v0
    :try_end_1c
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_e .. :try_end_1c} :catch_6a
    .catch Ljava/security/NoSuchProviderException; {:try_start_e .. :try_end_1c} :catch_4c
    ...
    :try_end_2c
    .catch Ljava/io/IOException; {:try_start_1d .. :try_end_2c} :catch_2e
...
.method createAsymmetricWrapper(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Map;)Ljavax/crypto/Cipher;
    .registers 7
    ...
    check-cast v1, Ljava/lang/String;
    :try_end_18
    .catch Ljava/security/GeneralSecurityException; {:try_start_1 .. :try_end_18} :catch_40
    ...
    move-result-object v1
    :try_end_21
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1b .. :try_end_21} :catch_22
    .catch Ljava/security/GeneralSecurityException; {:try_start_1b .. :try_end_21} :catch_40
    ...
    move-result v2
    :try_end_29
    .catch Ljava/security/GeneralSecurityException; {:try_start_23 .. :try_end_29} :catch_40
    ...
    .catch Ljava/security/GeneralSecurityException; {:try_start_2b .. :try_end_33} :catch_40
    ...
    move-result-object v1
    :try_end_3f
    .catch Ljava/security/GeneralSecurityException; {:try_start_35 .. :try_end_3f} :catch_40
...
.method createCipher(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljavax/crypto/Cipher;
    .registers 6
    .param p1, "algorithm"    # Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method createDigest(Lcom/android/internal/org/bouncycastle/asn1/x509/AlgorithmIdentifier;)Ljava/security/MessageDigest;
    .registers 5
...
.method createKeyAgreement(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljavax/crypto/KeyAgreement;
    .registers 6
    .param p1, "algorithm"    # Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .catch Ljava/security/GeneralSecurityException; {:try_start_3 .. :try_end_9} :catch_16
    ...
    move-result-object v1
    :try_end_15
    .catch Ljava/security/GeneralSecurityException; {:try_start_b .. :try_end_15} :catch_16
...
.method createKeyPairGenerator(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/security/KeyPairGenerator;
    .registers 6
    .param p1, "algorithm"    # Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public createRawSignature(Lcom/android/internal/org/bouncycastle/asn1/x509/AlgorithmIdentifier;)Ljava/security/Signature;
    .registers 6
...
.method createSignature(Lcom/android/internal/org/bouncycastle/asn1/x509/AlgorithmIdentifier;)Ljava/security/Signature;
    .registers 9
    ...
    move-result-object v1
    :try_end_a
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4 .. :try_end_a} :catch_b
    ...
    :try_end_89
    .catch Ljava/io/IOException; {:try_start_71 .. :try_end_89} :catch_8a
...
.method createSymmetricWrapper(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljavax/crypto/Cipher;
    .registers 6
    .param p1, "algorithm"    # Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    :try_end_8
    .catch Ljava/security/GeneralSecurityException; {:try_start_0 .. :try_end_8} :catch_1d
    ...
    .catch Ljava/security/GeneralSecurityException; {:try_start_a .. :try_end_10} :catch_1d
    ...
    move-result-object v1
    :try_end_1c
    .catch Ljava/security/GeneralSecurityException; {:try_start_12 .. :try_end_1c} :catch_1d
...
.method getKeyAlgorithmName(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    .registers 4
...
.method getKeySizeInBits(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)I
    .registers 3
...
.method getWrappingAlgorithmName(Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    .registers 3
    .param p1, "algOid"    # Lcom/android/internal/org/bouncycastle/asn1/ASN1ObjectIdentifier;
