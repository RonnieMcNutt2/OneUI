...
.method private static native enableFsverityForFdNative(I)I
.end method

.method private static native enableFsverityNative(Ljava/lang/String;)I
.end method

.method public static getFsverityDigest(Ljava/lang/String;)[B
    .registers 5
...
.method public static setUpFsverity(I)V
    .registers 5
    .param p0, "fd"    # I
...
.method public static setUpFsverity(Ljava/lang/String;)V
    .registers 5
    .param p0, "filePath"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static toFormattedDigest([B)[B
    .registers 4
    .param p0, "digest"    # [B
...
.method public static verifyPkcs7DetachedSignature([B[BLjava/io/InputStream;)Z
    .registers 12
    ...
    move-result v7
    :try_end_104
    .catch Ljava/security/cert/CertificateException; {:try_start_e .. :try_end_104} :catch_10b
    .catch Lcom/android/internal/org/bouncycastle/cms/CMSException; {:try_start_e .. :try_end_104} :catch_10b
    .catch Lcom/android/internal/org/bouncycastle/operator/OperatorCreationException; {:try_start_e .. :try_end_104} :catch_10b
