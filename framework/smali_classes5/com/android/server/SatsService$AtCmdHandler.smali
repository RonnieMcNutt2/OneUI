...
.field private static final USB_SOCKET_NAME:Ljava/lang/String; = "/data/misc/.socket_stream"
...
.method private closeInputStream(Landroid/net/LocalSocket;)V
    .registers 3
...
.method private closeLocalSocket(Landroid/net/LocalSocket;)V
    .registers 3
    .param p1, "socket"    # Landroid/net/LocalSocket;
...
.method private closeOutputStream(Landroid/net/LocalSocket;)V
    .registers 3
    .param p1, "socket"    # Landroid/net/LocalSocket;
...
.method private executeEmAtCommand(Ljava/lang/String;)Ljava/lang/String;
    .registers 20
    .param p1, "cmd"    # Ljava/lang/String;
...
.method private isValidCommand(Ljava/lang/String;)Z
    ...
    :try_end_7b
    .catch Ljava/lang/Exception; {:try_start_2c .. :try_end_7b} :catch_7e
...
.method public run()V
    ...
    :try_end_6b
    .catch Ljava/lang/Exception; {:try_start_43 .. :try_end_6b} :catch_6c
    ...
    :try_end_14e
    .catch Ljava/lang/Exception; {:try_start_8c .. :try_end_14e} :catch_14f
    ...
    monitor-enter v0
    :try_end_1a1
    .catch Ljava/lang/Exception; {:try_start_186 .. :try_end_1a1} :catch_1b8
    ...
    monitor-exit v0
    :try_end_1b7
    .catchall {:try_start_1a1 .. :try_end_1b7} :catchall_1b5

    .end local p0    # "this":Lcom/android/server/SatsService$AtCmdHandler;
    :try_start_1b7
    throw v1
    :try_end_1b8
    .catch Ljava/lang/Exception; {:try_start_1b7 .. :try_end_1b8} :catch_1b8
