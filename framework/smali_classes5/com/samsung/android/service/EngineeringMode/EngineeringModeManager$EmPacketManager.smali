...
.method private parseDeviceInfo([BI)I
    ...
    if-eq v10, v14, :cond_d5

    if-eq v10, v12, :cond_d5

    if-eq v10, v13, :cond_d5
...
.method private parseGroupDb([BI)I
    ...
    :try_end_f6
    .catch Ljava/lang/Exception; {:try_start_37 .. :try_end_f6} :catch_fc
...
.method private parseIssuerInfo([BI)I
    ...
    if-eq v10, v13, :cond_e1

    if-eq v10, v12, :cond_e1

    if-eq v10, v6, :cond_e1

    if-eq v10, v15, :cond_e1

    if-eq v10, v14, :cond_e1
...
.method private parseTokenInfo([BI)I
    ...
    if-eq v11, v13, :cond_d6

    if-eq v11, v14, :cond_d6
