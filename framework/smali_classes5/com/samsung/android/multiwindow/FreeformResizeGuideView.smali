...
.field private final mAnimList:Ljava/util/ArrayList;
...
.field private mDimViewMargin:I

.field private mFullscreenDimViewMargin:I

.field private mHeightAnimator:Landroid/animation/ValueAnimator;

.field private mIsTransition:Z

.field private mLeftMarginAnimator:Landroid/animation/ValueAnimator;

.field private mToFullScreen:Z

.field private mTopMarginAnimator:Landroid/animation/ValueAnimator;

.field private mWidthAnimator:Landroid/animation/ValueAnimator;


# direct methods
.method public static synthetic $r8$lambda$-MC3vAHq_gh1Pf15fOkHnA6JVT4(Lcom/samsung/android/multiwindow/FreeformResizeGuideView;Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 3
...
.method public static synthetic $r8$lambda$8SXrE5ZZXK-KblpW6gVR_7KGfec(Lcom/samsung/android/multiwindow/FreeformResizeGuideView;Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 3
...
.method public static synthetic $r8$lambda$BF5si09-tJtKlzhAkr1j4uf7TPo(Lcom/samsung/android/multiwindow/FreeformResizeGuideView;Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 3
...
.method public static synthetic $r8$lambda$ib_r2ngEmABe2N6OSeDmPWikXrU(Lcom/samsung/android/multiwindow/FreeformResizeGuideView;Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 3
...
.method public static synthetic $r8$lambda$qjCqn_3Hcn-b_FL6R8qv_y2_5sI(Lcom/samsung/android/multiwindow/FreeformResizeGuideView;Landroid/animation/ValueAnimator;)V
    .registers 2
...
.method static bridge synthetic -$$Nest$fgetmAppIconView(Lcom/samsung/android/multiwindow/FreeformResizeGuideView;)Landroid/widget/ImageView;
    .registers 1
...
.method private getGuideResourceId(I)I
    .registers 3
...
.method private getOrCreateValueAnimator(Landroid/animation/ValueAnimator;IILandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator;
    .registers 6
...
.method private synthetic lambda$show$0(Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 4
...
.method private synthetic lambda$show$1(Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 4
    .param p1, "dimLp"    # Landroid/widget/FrameLayout$LayoutParams;
    .param p2, "animation"    # Landroid/animation/ValueAnimator;
...
.method private synthetic lambda$show$2(Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 4
    .param p1, "dimLp"    # Landroid/widget/FrameLayout$LayoutParams;
    .param p2, "animation"    # Landroid/animation/ValueAnimator;
...
.method private synthetic lambda$show$3(Landroid/widget/FrameLayout$LayoutParams;Landroid/animation/ValueAnimator;)V
    .registers 4
    .param p1, "dimLp"    # Landroid/widget/FrameLayout$LayoutParams;
    .param p2, "animation"    # Landroid/animation/ValueAnimator;
...
.method private varargs removeAllUpdateListenersIfNeeded([Landroid/animation/ValueAnimator;)V
    .registers 5
...
.method setDimViewVisibility(I)V
    .registers 3
...
.method show(Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    .registers 10
...
.method show(Landroid/graphics/Rect;Landroid/graphics/Rect;ZZLcom/samsung/android/multiwindow/FreeformResizeGuide$TransitionInfo;)V
    .registers 33
    .param p1, "lastBounds"    # Landroid/graphics/Rect;
    .param p2, "bounds"    # Landroid/graphics/Rect;
...
.method startHideAppIconAnimation()V
    .registers 8
...
.method startShowAppIconAnimation()V
    .registers 14
...
.method update(ILjava/lang/String;)V
    .registers 7
    .param p1, "dexDockingState"    # I
    ...
    .line 99
    iput v1, p0, Lcom/samsung/android/multiwindow/FreeformResizeGuideView;->mDimViewMargin:I

    .line 100
    iput v1, p0, Lcom/samsung/android/multiwindow/FreeformResizeGuideView;->mFullscreenDimViewMargin:I
    ...
    .line 108
    invoke-virtual {v2, p2, v1, v3}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
