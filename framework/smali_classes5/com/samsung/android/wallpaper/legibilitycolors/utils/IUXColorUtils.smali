...
# static fields
.field public static final COLOR8_TO_NORMALIZED:F = 0.003921569f

.field static final GRAYSCALE_THRESHOLD_BRIGHTNESS:F = 0.25f

.field static final GRAYSCALE_THRESHOLD_SATURATION:F = 0.12f
...
.method public static HSVToColor([FF)I
    .registers 17
    .param p0, "hsv"    # [F
    .param p1, "alpha"    # F
...
.method public static addColorColor(II)I
    .registers 7
    .param p0, "colorA"    # I
    .param p1, "colorB"    # I
...
.method public static caculateLuminosity(I)F
    .registers 4
    .param p0, "color"    # I
...
.method public static caculateLuminosity(III)F
    .registers 6
    .param p0, "r"    # I
    .param p1, "g"    # I
    .param p2, "b"    # I
...
.method public static caculateLuminosity2(I)F
    .registers 4
    .param p0, "color"    # I
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public static caculateLuminosity2(III)F
    .registers 6
    .param p0, "r"    # I
    .param p1, "g"    # I
    .param p2, "b"    # I
...
.method public static calculateGrayScaleColor(I)F
    .registers 4
    .param p0, "color"    # I
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public static calculateGrayScaleColor(III)F
    .registers 5
    .param p0, "r"    # I
    .param p1, "g"    # I
    .param p2, "b"    # I
...
.method public static calculateHsvPositionFromCornSpace([FF[F)V
    .registers 11
    .param p0, "hsv"    # [F
    .param p1, "sWeight"    # F
    .param p2, "result"    # [F
...
.method public static calculateHsvPositionFromCornSpaceDouble([FD[D)V
    .registers 15
    .param p0, "hsv"    # [F
    .param p1, "sWeight"    # D
    .param p3, "result"    # [D
...
.method public static calculateLuminance(III)F
    .registers 25
    .param p0, "r"    # I
    .param p1, "g"    # I
    .param p2, "b"    # I
...
.method public static calculateLuminanceInLinearSpace(I)F
    .registers 4
    .param p0, "color"    # I
...
.method public static calculateLuminanceInLinearSpace(III)F
    .registers 6
    .param p0, "r"    # I
    .param p1, "g"    # I
    .param p2, "b"    # I
...
.method public static checkGayScale(ID)Z
    .registers 7
    .param p0, "color"    # I
...
.method public static checkGayScale([FD)Z
    .registers 8
    .param p0, "hsv"    # [F
    .param p1, "offsetValue"    # D
...
.method public static checkGrayScaleWithSV([FFF)Z
    .registers 5
    .param p0, "hsv"    # [F
...
.method public static checkSameHSV([F[F)Z
    .registers 6
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
...
.method public static checkSameHSV([F[FF)Z
    .registers 16
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
...
.method public static checkWhite(ID)Z
    .registers 7
    .param p0, "color"    # I
    .param p1, "offsetValue"    # D
...
.method public static checkWhite([FD)Z
    .registers 8
    .param p0, "hsv"    # [F
    .param p1, "offsetValue"    # D
...
.method public static colorDistanceHSV([F[F[F)D
    .registers 20
    .param p0, "hsv_a"    # [F
    .param p1, "hsv_b"    # [F
...
.method public static colorDistanceHueFast(FF)D
    .registers 8
    .param p0, "hueA"    # F
    .param p1, "hueB"    # F
...
.method public static colorDistance_hsv([F[F[F)D
    .registers 5
    .param p0, "hsv_a"    # [F
    .param p1, "hsv_b"    # [F
    .param p2, "hsv_weight"    # [F
...
.method public static colorDistance_hsv_square2([F[F[F)D
    .registers 20
    .param p0, "hsv_a"    # [F
    .param p1, "hsv_b"    # [F
    .param p2, "hsv_weight"    # [F
...
.method public static colorDistance_hue(FF)D
    .registers 10
    .param p0, "hueA"    # F
    .param p1, "hueB"    # F
...
.method public static colorDistance_hue([F[F)D
    .registers 4
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
...
.method public static colorDistance_rgb(II)D
    .registers 8
    .param p0, "c1"    # I
    .param p1, "c2"    # I
...
.method public static colorDistance_rgb_sqaure2(II)D
    .registers 8
    .param p0, "c1"    # I
    .param p1, "c2"    # I
...
.method public static colorToHSV(III[F)V
    .registers 15
    .param p0, "r"    # I
    .param p1, "g"    # I
    .param p2, "b"    # I
...
.method public static combinAlphaIntoIntColor(II)I
    .registers 4
    .param p0, "alpha"    # I
    .param p1, "color"    # I
...
.method public static convertHsv2CornSpace([FF[F)V
    .registers 10
    .param p0, "hsv"    # [F
    .param p1, "weight"    # F
    .param p2, "dst"    # [F
...
.method public static copyHSVToHSV([F[F)V
    .registers 4
    .param p0, "dst"    # [F
    .param p1, "src"    # [F
...
.method public static getAlphaRatio(I)F
    .registers 3
    .param p0, "color"    # I
...
.method public static getAvgHSVFromTwoHSV([F[F)[F
    .registers 8
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
...
.method public static getBlueRatio(I)F
    .registers 3
    .param p0, "color"    # I
...
.method public static getColorFromChannelValue(I)I
    .registers 2
    .param p0, "aChannel"    # I
...
.method public static getColorFromLuminance(F)I
    .registers 3
...
.method public static getCopiedHSV([F)[F
    .registers 4
    .param p0, "srcHSV"    # [F
...
.method public static getGammaCorrectedValue(F)F
    .registers 5
    .param p0, "value"    # F
...
.method public static getGammaCorrectionFromValue(D)D
    .registers 6
    .param p0, "val"    # D
...
.method public static getGreenRatio(I)F
    .registers 3
    .param p0, "color"    # I
...
.method public static getHSVFromColor(I)[F
    .registers 2
    .param p0, "color"    # I
...
.method public static getHsvDistanceSquare2FromCornSpace([F[F)F
    .registers 6
...
.method public static getHsvDistanceSquare2FromCornSpace([F[FF)F
    .registers 9
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "d"    # F
...
.method public static getHsvDistanceSquare2FromCornSpace([F[FF[F[F)F
    .registers 19
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "d"    # F
...
.method public static getHsvDistanceSquare2FromCornSpaceDouble([F[FF)D
    .registers 9
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "d"    # F
...
.method public static getHsvDistanceSquare2FromCornSpaceDouble([F[FF[F[F)D
    .registers 9
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "d"    # F
...
.method public static getHsvDistanceSquare2FromCornSpaceDoubleFast([F[FF)D
    .registers 15
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "d"    # F
...
.method public static getHsvPositionFromCornSpace([FF)[F
    .registers 3
    .param p0, "hsv"    # [F
    .param p1, "sWeight"    # F
...
.method public static getHsvPositionFromCornSpaceDouble([FD)[D
    .registers 4
    .param p0, "hsv"    # [F
    .param p1, "sWeight"    # D
...
.method public static getHumanEyeBasedHueNormalizedDistance(F)F
    .registers 9
    .param p0, "hue"    # F
...
.method public static getInterpolatedColorHSVBased([F[FF)I
    .registers 5
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "value"    # F
...
.method public static getInterpolatedHSV([F[FF)[F
    .registers 19
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "value"    # F
...
.method public static getInverseHSV([F)[F
    .registers 5
    .param p0, "hsv"    # [F
...
.method public static getRGBFromColor(I)[I
    .registers 5
    .param p0, "color"    # I
...
.method public static getRedRatio(I)F
    .registers 3
    .param p0, "color"    # I
...
.method public static hsvDistanceSquare2([F[F[F)D
    .registers 20
    .param p0, "hsv_a"    # [F
    .param p1, "hsv_b"    # [F
    .param p2, "hsv_weight"    # [F
...
.method public static interpolateHSV([F[FF)[F
    .registers 11
    .param p0, "hsvA"    # [F
    .param p1, "hsvB"    # [F
    .param p2, "value"    # F
...
.method public static multipleColorValue(IF)I
    .registers 5
    .param p0, "color"    # I
    .param p1, "value"    # F
...
.method public static resetHSVBlack([F)V
    .registers 3
    .param p0, "dst"    # [F
...
.method public static setHSV([FFFF)V
    .registers 5
    .param p0, "dst"    # [F
    .param p1, "hue"    # F
...
# virtual methods
.method getGradation(IIIIF)Landroid/graphics/Bitmap;
    .registers 14
    .param p1, "colorA"    # I
    .param p2, "colorB"    # I
