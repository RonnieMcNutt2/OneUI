...
.field private static final TAG:Ljava/lang/String; = "ColorScheme"


# instance fields
.field private accent1:Ljava/util/List;
...
.field private accent2:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field private accent3:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field private neutral1:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field private neutral2:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field private final style:Lcom/samsung/android/wallpaper/colortheme/monet/Style;
...
.method public constructor <init>(IZLcom/samsung/android/wallpaper/colortheme/monet/Style;)V
    .registers 4
    .param p1, "seed"    # I
    .param p2, "darkTheme"    # Z
...
.method public constructor <init>(Landroid/app/WallpaperColors;ZLcom/samsung/android/wallpaper/colortheme/monet/Style;)V
    .registers 5
    .param p1, "wallpaperColors"    # Landroid/app/WallpaperColors;
    .param p2, "darkTheme"    # Z
    .param p3, "style"    # Lcom/samsung/android/wallpaper/colortheme/monet/Style;
...
.method private static entriesSortedByValues(Ljava/util/Map;)Ljava/util/List;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method private static hueDiff(FF)F
    .registers 4
    .param p0, "a"    # F
    .param p1, "b"    # F
...
.method private static final stringForColor(I)Ljava/lang/String;
    .registers 8
    .param p0, "color"    # I
...
.method public allAccentColors()Ljava/util/List;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public allNeutralColors()Ljava/util/List;
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getAccent1()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getAccent2()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getAccent3()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getNeutral1()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getNeutral2()Ljava/util/List;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final getStyle()Lcom/samsung/android/wallpaper/colortheme/monet/Style;
    .registers 2
