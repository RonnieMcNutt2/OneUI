...
.field private static volatile mInstance:Lcom/samsung/android/knox/dar/ddar/DualDARController;
...
.method public static getInstance(Landroid/content/Context;)Lcom/samsung/android/knox/dar/ddar/DualDARController;
    .registers 3
...
.method private processCommandAsync(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    .registers 6
    .param p1, "command"    # Ljava/lang/String;
    .param p2, "params"    # Landroid/os/Bundle;
...
.method public handleBeforeUnlockUser(I)Z
    .registers 8
    .param p1, "userId"    # I
...
.method public handleDeviceOwnerProvisioning()Z
    .registers 7
...
.method public onDualDarStateChanged(Lcom/samsung/android/knox/dar/ddar/fsm/State;Lcom/samsung/android/knox/dar/ddar/fsm/State;Lcom/samsung/android/knox/dar/ddar/fsm/Event;I)Z
    .registers 10
...
.method public onPassword2Auth(I[B)Z
    .registers 10
    .param p1, "userId"    # I
...
.method public onPassword2Change(I[B[B)Z
    .registers 10
    .param p1, "userId"    # I
...
.method public resetPasswordWithToken(I[BJ[B)Z
    .registers 11
    .param p1, "dualDarUserId"    # I
...
.method public setResetPasswordToken(I[BJ[B)Z
    .registers 11
    .param p1, "dualDarUserId"    # I
    .param p2, "password"    # [B
    .param p3, "tokenHandle"    # J
