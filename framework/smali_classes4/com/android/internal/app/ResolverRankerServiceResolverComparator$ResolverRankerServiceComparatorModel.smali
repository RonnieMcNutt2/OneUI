...
.field private final mPmMap:Ljava/util/Map;
...
.field private final mStatsPerUser:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Landroid/os/UserHandle;",
...
.field private final mTargetsDictPerUser:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Landroid/os/UserHandle;",
...
# direct methods
.method public static synthetic $r8$lambda$cU4cPiiICvLaL3mI3wcZ4mxlPhw(Lcom/android/internal/app/ResolverRankerServiceResolverComparator$ResolverRankerServiceComparatorModel;Landroid/content/pm/ResolveInfo;Landroid/content/pm/ResolveInfo;)I
    .registers 3
...
.method constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/List;Ljava/text/Collator;Landroid/service/resolver/IResolverRankerService;Landroid/content/ComponentName;ZLjava/util/Map;)V
    .registers 9
...
.method private getActivityResolverTargetForUser(Landroid/content/pm/ActivityInfo;Landroid/os/UserHandle;)Landroid/service/resolver/ResolverTarget;
    .registers 7
...
.method private synthetic lambda$getComparator$0(Landroid/content/pm/ResolveInfo;Landroid/content/pm/ResolveInfo;)I
    .registers 10
...
.method public notifyOnTargetSelected(Lcom/android/internal/app/chooser/TargetInfo;)V
    .registers 8
    .param p1, "targetInfo"    # Lcom/android/internal/app/chooser/TargetInfo;
    ...
    :try_end_65
    .catch Landroid/os/RemoteException; {:try_start_5 .. :try_end_65} :catch_66
