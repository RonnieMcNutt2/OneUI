...
.field private static final PROP_APP_LANGUAGE_SUGGESTION:Ljava/lang/String; = "android.app.language.suggestion.enhanced"

.field private static final TAG:Ljava/lang/String;


# instance fields
.field private mAllAppActiveLocales:Ljava/util/Set;
...
.field private mAppCurrentLocale:Lcom/android/internal/app/LocaleStore$LocaleInfo;

.field private final mAppPackageName:Ljava/lang/String;

.field private final mContext:Landroid/content/Context;

.field private mImeLocales:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/android/internal/app/LocaleStore$LocaleInfo;",
...
.method private addImeSuggestionFlag(Ljava/util/Set;)Ljava/util/Set;
    .registers 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private addSystemSuggestionFlag(Lcom/android/internal/app/LocaleStore$LocaleInfo;Ljava/util/Set;)Z
    .registers 7
...
.method private filterSameLanguageAndCountry(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    .registers 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private filterSupportedLocales(Ljava/util/Set;Ljava/util/HashSet;)Ljava/util/Set;
    .registers 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getActiveIme(Landroid/view/inputmethod/InputMethodManager;)Landroid/view/inputmethod/InputMethodInfo;
    .registers 8
...
.method private getSuggestedLocales(Ljava/util/Set;)Ljava/util/Set;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static synthetic lambda$getActiveImeLocales$1(Lcom/android/internal/app/LocaleStore$LocaleInfo;)Z
    .registers 2
...
.method static synthetic lambda$getAllAppActiveLocales$0(Ljava/util/HashSet;Ljava/lang/String;Lcom/android/internal/app/LocaleStore$LocaleInfo;)V
    .registers 3
...
.method static synthetic lambda$getIgnoredLocaleList$3(Ljava/util/HashSet;Lcom/android/internal/app/LocaleStore$LocaleInfo;)V
    .registers 3
...
.method static synthetic lambda$getIgnoredLocaleList$4(Ljava/util/HashSet;Lcom/android/internal/app/LocaleStore$LocaleInfo;)V
    .registers 3
    .param p0, "langTagsToIgnore"    # Ljava/util/HashSet;
    .param p1, "info"    # Lcom/android/internal/app/LocaleStore$LocaleInfo;
...
.method static synthetic lambda$getSuggestedLocales$5(Lcom/android/internal/app/LocaleStore$LocaleInfo;)Z
    .registers 2
...
.method static synthetic lambda$getSystemCurrentLocales$2(Lcom/android/internal/app/LocaleStore$LocaleInfo;)Z
    .registers 2
    .param p0, "info"    # Lcom/android/internal/app/LocaleStore$LocaleInfo;
...
# virtual methods
.method public getActiveImeLocales()Ljava/util/Set;
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getAllAppActiveLocales()Ljava/util/Set;
    .registers 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getAppCurrentLocale()Lcom/android/internal/app/LocaleStore$LocaleInfo;
    .registers 4
...
.method public getAppSupportedLocales()Lcom/android/internal/app/AppLocaleStore$AppLocaleResult;
    .registers 3
...
.method public getIgnoredLocaleList(Z)Ljava/util/HashSet;
    .registers 6
...
.method public getSupportedLocaleList(Lcom/android/internal/app/LocaleStore$LocaleInfo;ZZ)Ljava/util/Set;
    .registers 20
...
.method public getSystemCurrentLocales()Ljava/util/Set;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getSystemSupportedLocale(Ljava/util/Set;Lcom/android/internal/app/LocaleStore$LocaleInfo;Z)Ljava/util/Set;
    .registers 5
...
.method public hasSpecificPackageName()Z
    .registers 2
