...
# static fields
.field private static final INVERT_MASK:I = 0x2

.field private static final I_SHIFT:I = 0x21

.field private static final J_MASK:J = 0x7fffffffL

.field private static final J_SHIFT:I = 0x2

.field private static final LEAF_MASK:I = 0x1

.field private static final LOOKUP_BITS:I = 0x4

.field private static final LOOKUP_IJ:[I

.field private static final LOOKUP_MASK:I = 0xf

.field private static final LOOKUP_POS:[I

.field public static final MAX_LEVEL:I = 0x1e

.field private static final MAX_SIZE:I = 0x40000000

.field private static final NUM_FACES:I = 0x6

.field private static final ONE_OVER_MAX_SIZE:D = 9.313225746154785E-10

.field private static final POS_BITS:I = 0x3d

.field private static final POS_TO_IJ:[[I

.field private static final POS_TO_ORIENTATION:[I

.field private static final SWAP_MASK:I = 0x1

.field private static final UV_LIMIT:D

.field private static final UV_TRANSFORMS:[Lcom/android/internal/location/altitude/S2CellIdUtils$UvTransform;

.field private static final XYZ_TRANSFORMS:[Lcom/android/internal/location/altitude/S2CellIdUtils$XyzTransform;
...
.method private static calculateUvLimit()D
    .registers 6
...
.method private static createUvTransforms()[Lcom/android/internal/location/altitude/S2CellIdUtils$UvTransform;
    .registers 3
...
.method private static createXyzTransforms()[Lcom/android/internal/location/altitude/S2CellIdUtils$XyzTransform;
    .registers 3
...
.method private static fromFij(III)J
    .registers 12
    .param p0, "face"    # I
    .param p1, "i"    # I
    .param p2, "j"    # I
...
.method private static fromFijSame(IIIZ)J
    .registers 6
    .param p0, "face"    # I
    .param p1, "i"    # I
    .param p2, "j"    # I
...
.method private static fromFijWrap(III)J
    .registers 26
    .param p0, "face"    # I
    .param p1, "i"    # I
    .param p2, "j"    # I
...
.method private static fromFuv(IDD)J
    .registers 9
    .param p0, "face"    # I
    .param p1, "u"    # D
    .param p3, "v"    # D
...
.method public static fromLatLngDegrees(DD)J
    .registers 8
...
.method private static fromLatLngRadians(DD)J
    .registers 18
...
.method private static fromXyz(DDD)J
    .registers 17
    .param p0, "x"    # D
    .param p2, "y"    # D
    .param p4, "z"    # D
...
.method public static getEdgeNeighbors(J[J)V
    .registers 23
    .param p0, "s2CellId"    # J
...
.method private static getFace(J)I
    .registers 4
    .param p0, "s2CellId"    # J
...
.method static getLowestOnBit(J)J
    .registers 4
    .param p0, "s2CellId"    # J
...
.method static getLowestOnBitForLevel(I)J
    .registers 4
    .param p0, "level"    # I
...
.method public static getParent(JI)J
    .registers 7
    .param p0, "s2CellId"    # J
    .param p2, "level"    # I
...
.method static getToken(J)Ljava/lang/String;
    .registers 6
    .param p0, "s2CellId"    # J
...
.method static getTraversalNext(J)J
    .registers 5
    .param p0, "s2CellId"    # J
...
.method static getTraversalStart(JI)J
    .registers 7
    .param p0, "s2CellId"    # J
    .param p2, "level"    # I
...
.method private static iToU(I)D
    .registers 11
    .param p0, "i"    # I
...
.method private static ijoToI(J)I
    .registers 4
    .param p0, "ijo"    # J
...
.method private static ijoToJ(J)I
    .registers 6
    .param p0, "ijo"    # J
...
.method private static initLookupCell(IIIIII)V
    .registers 16
    .param p0, "level"    # I
    .param p1, "i"    # I
    .param p2, "j"    # I
...
.method private static initLookupCells()V
    .registers 12
...
.method private static isLeaf(J)Z
    .registers 4
    .param p0, "s2CellId"    # J
...
.method private static jToV(I)D
    .registers 3
    .param p0, "j"    # I
...
.method private static levelToSizeIj(I)I
    .registers 3
    .param p0, "level"    # I
...
.method private static lookupBits(IIII)I
    .registers 5
    .param p0, "i"    # I
    .param p1, "j"    # I
    .param p2, "k"    # I
...
.method private static maskBits(I)I
    .registers 2
    .param p0, "bits"    # I
...
.method private static padStart(Ljava/lang/String;)Ljava/lang/String;
    .registers 4
...
.method private static toIjo(J)J
    .registers 12
    .param p0, "s2CellId"    # J
...
.method private static uShiftIntoI(D)I
    .registers 8
    .param p0, "u"    # D
...
.method private static uToI(D)I
    .registers 9
    .param p0, "u"    # D
...
.method private static updateBits(JII)J
    .registers 8
    .param p0, "sb"    # J
    .param p2, "k"    # I
    .param p3, "bits"    # I
...
.method private static vShiftIntoJ(D)I
    .registers 3
    .param p0, "v"    # D
...
.method private static vToJ(D)I
    .registers 3
    .param p0, "v"    # D
...
.method private static xyzToFace(DDD)I
    .registers 17
    .param p0, "x"    # D
    .param p2, "y"    # D
    .param p4, "z"    # D
