...
.field private static final FRRO_EXTENSION:Ljava/lang/String; = ".frro"

.field private static final IDMAP_EXTENSION:Ljava/lang/String; = ".idmap"

.field public static final SELF_TARGET:Ljava/lang/String; = ".self_target"

.field private static final TAG:Ljava/lang/String; = "OverlayManagerImpl"


# instance fields
.field private mBasePath:Ljava/nio/file/Path;
...
.method public static checkOverlayNameValid(Ljava/lang/String;)Ljava/lang/String;
    .registers 6
...
.method private static cleanExpiredOverlays(Ljava/nio/file/Path;Ljava/nio/file/Path;)V
    .registers 5
...
.method private static native createFrroFile(Ljava/lang/String;Landroid/os/FabricatedOverlayInternal;)V
...
.method private static native createIdmapFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZZZZZ)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private static native getFabricatedOverlayInfo(Ljava/lang/String;)Landroid/os/FabricatedOverlayInfo;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private isSameWithTargetSignature(Ljava/lang/String;)Z
    .registers 6
...
.method static synthetic lambda$getOverlayInfosForTarget$0(Ljava/io/File;Ljava/lang/String;)Z
    .registers 6
...
.method public getOverlayInfosForTarget(Ljava/lang/String;)Ljava/util/List;
    ...
    move-result-object v0
    :try_end_29
    .catch Ljava/io/IOException; {:try_start_21 .. :try_end_29} :catch_59
...
.method public registerFabricatedOverlay(Landroid/os/FabricatedOverlayInternal;)V
    .registers 21
    ...
    move-result v0
    :try_end_8f
    .catch Ljava/io/IOException; {:try_start_83 .. :try_end_8f} :catch_c0
    ...
    move-result v0
    :try_end_95
    .catch Ljava/io/IOException; {:try_start_91 .. :try_end_95} :catch_9a
    ...
    move-result v0
    :try_end_b4
    .catch Ljava/io/IOException; {:try_start_9e .. :try_end_b4} :catch_c0
...
.method public unregisterFabricatedOverlay(Ljava/lang/String;)V
    .registers 7
