...
# static fields
.field public static final ACCESSIBILITY_MENU_IN_SYSTEM:Landroid/content/ComponentName;

.field public static final MENU_SERVICE_RELATIVE_CLASS_NAME:Ljava/lang/String; = ".AccessibilityMenuService"
...
.field private static isVisibleShortcutDialog:Z
...
.method private static allowPerformInEmergencyMode(Ljava/lang/String;)Z
    .registers 4
...
.method private static disAllowPerformInDexMode(Ljava/lang/String;)Z
    .registers 3
    .param p0, "targetName"    # Ljava/lang/String;
...
.method private static findA11yMenuComponentNames(Landroid/content/pm/PackageManager;I)Ljava/util/Set;
    .registers 9
...
.method public static getAccessibilityMenuComponentToMigrate(Landroid/content/pm/PackageManager;I)Landroid/content/ComponentName;
    .registers 6
    .param p0, "packageManager"    # Landroid/content/pm/PackageManager;
    .param p1, "userId"    # I
...
.method public static getVisiblityShortcutDialog()Z
    .registers 1
...
.method public static interceptHeadsetHookForActiveCall(Landroid/content/Context;)Z
    .registers 6
    .param p0, "context"    # Landroid/content/Context;
...
.method public static isAccessControlEnabled(Landroid/content/Context;)Z
    .registers 5
    .param p0, "context"    # Landroid/content/Context;
...
.method public static isSetupWizard(Landroid/content/Context;)Z
    .registers 4
    .param p0, "context"    # Landroid/content/Context;
...
.method public static isSideKeySupported()Z
    .registers 2
...
.method static synthetic lambda$getAccessibilityMenuComponentToMigrate$0(Landroid/content/ComponentName;)Z
    .registers 2
...
.method public static makeToastForDexMode(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .registers 7
    .param p0, "context"    # Landroid/content/Context;
...
.method public static makeToastForEmergencyMode(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    .registers 7
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "targetName"    # Ljava/lang/String;
    .param p2, "targetLabel"    # Ljava/lang/String;
...
.method public static setVisibilityShortcutDialog(Z)V
    .registers 1
    .param p0, "visible"    # Z
...
.method public static turnOffAccessControl(Landroid/content/Context;)V
    .registers 5
    .param p0, "context"    # Landroid/content/Context;
...
.method public static updateProfile(Landroid/content/Context;Ljava/lang/String;)V
    .registers 5
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "targetName"    # Ljava/lang/String;
