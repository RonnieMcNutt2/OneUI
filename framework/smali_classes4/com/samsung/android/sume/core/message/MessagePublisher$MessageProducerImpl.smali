...
# direct methods
.method constructor <init>(Lcom/samsung/android/sume/core/message/MessagePublisher;)V
    .registers 3
...
.method static synthetic lambda$newMessage$0(ILcom/samsung/android/sume/core/message/MessagePublisher;)Lcom/samsung/android/sume/core/message/Message;
    .registers 3
    .param p0, "code"    # I
...
.method static synthetic lambda$newMessage$1(ILjava/util/Map;Lcom/samsung/android/sume/core/message/MessagePublisher;)Lcom/samsung/android/sume/core/message/Message;
    .registers 4
    .param p0, "code"    # I
...
# virtual methods
.method synthetic lambda$newMessage$2$com-samsung-android-sume-core-message-MessagePublisher$MessageProducerImpl(ILjava/lang/Object;Lcom/samsung/android/sume/core/message/MessagePublisher;)Lcom/samsung/android/sume/core/message/Message;
    .registers 5
    .param p1, "code"    # I
...
.method synthetic lambda$newMessage$3$com-samsung-android-sume-core-message-MessagePublisher$MessageProducerImpl(ILjava/lang/String;Ljava/lang/Object;Lcom/samsung/android/sume/core/message/MessagePublisher;)Lcom/samsung/android/sume/core/message/Message;
    .registers 6
    .param p1, "code"    # I
...
.method synthetic lambda$newMessage$4$com-samsung-android-sume-core-message-MessagePublisher$MessageProducerImpl(I[Landroid/util/Pair;Lcom/samsung/android/sume/core/message/MessagePublisher;)Lcom/samsung/android/sume/core/message/Message;
    .registers 5
    .param p1, "code"    # I
...
.method public newMessage(I)Lcom/samsung/android/sume/core/message/Message;
    .registers 4
    .param p1, "code"    # I
...
.method public newMessage(ILjava/lang/Object;)Lcom/samsung/android/sume/core/message/Message;
    .registers 5
    .param p1, "code"    # I
    .param p2, "data"    # Ljava/lang/Object;
...
.method public newMessage(ILjava/lang/String;Ljava/lang/Object;)Lcom/samsung/android/sume/core/message/Message;
    .registers 6
    .param p1, "code"    # I
    .param p2, "key"    # Ljava/lang/String;
    .param p3, "data"    # Ljava/lang/Object;
...
.method public newMessage(ILjava/util/Map;)Lcom/samsung/android/sume/core/message/Message;
    .registers 5
    .param p1, "code"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public varargs newMessage(I[Landroid/util/Pair;)Lcom/samsung/android/sume/core/message/Message;
    .registers 5
    .param p1, "code"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
