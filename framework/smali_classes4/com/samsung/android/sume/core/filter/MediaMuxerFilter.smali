...
.field private channelReady:Ljava/util/concurrent/atomic/AtomicReference;
...
.field private contentsFormat:Lcom/samsung/android/sume/core/format/MutableMediaFormat;

.field private cvPause:Landroid/os/ConditionVariable;

.field private final descriptor:Lcom/samsung/android/sume/core/descriptor/MediaMuxerDescriptor;

.field private diskCache:Lcom/samsung/android/sume/core/cache/DiskCache;

.field private messageProducer:Lcom/samsung/android/sume/core/message/MessageProducer;

.field private muxer:Landroid/media/MediaMuxer;

.field private outputFd:Ljava/io/FileDescriptor;

.field private final readyToStart:Ljava/util/concurrent/Semaphore;

.field private receiveChannelCount:I

.field private receiveChannelQuery:Ljava/util/function/Function;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lcom/samsung/android/sume/core/descriptor/MediaMuxerDescriptor;)V
    .registers 4
...
.method synthetic lambda$feedExistFramesToBufferChannel$0$com-samsung-android-sume-core-filter-MediaMuxerFilter(Landroid/media/MediaExtractor;I)V
    .registers 15
...
.method synthetic lambda$run$1$com-samsung-android-sume-core-filter-MediaMuxerFilter(Landroid/util/Pair;Lcom/samsung/android/sume/core/types/MediaType;)Ljava/lang/Boolean;
    .registers 22
    ...
    :try_end_d7
    .catch Ljava/lang/Exception; {:try_start_d2 .. :try_end_d7} :catch_d8
...
.method synthetic lambda$run$2$com-samsung-android-sume-core-filter-MediaMuxerFilter(Ljava/util/List;Lcom/samsung/android/sume/core/types/MediaType;Landroid/util/Pair;)V
    .registers 6
...
.method synthetic lambda$run$3$com-samsung-android-sume-core-filter-MediaMuxerFilter(Ljava/io/File;)Ljava/lang/Boolean;
    .registers 8
    ...
    move-result-object v1
    :try_end_20
    .catch Landroid/system/ErrnoException; {:try_start_0 .. :try_end_20} :catch_21
...
.method public onMessageReceived(Lcom/samsung/android/sume/core/message/Message;)Z
    ...
    :try_end_e7
    .catch Ljava/io/IOException; {:try_start_e4 .. :try_end_e7} :catch_f4
    ...
    :try_end_127
    .catch Ljava/io/IOException; {:try_start_11e .. :try_end_127} :catch_128
...
.method public run(Lcom/samsung/android/sume/core/buffer/MediaBuffer;Lcom/samsung/android/sume/core/buffer/MutableMediaBuffer;)Lcom/samsung/android/sume/core/buffer/MutableMediaBuffer;
    ...
    :try_end_5e
    .catch Ljava/lang/InterruptedException; {:try_start_4 .. :try_end_5e} :catch_13c
    .catchall {:try_start_4 .. :try_end_5e} :catchall_13a
    ...
    :try_end_7b
    .catch Ljava/util/concurrent/CancellationException; {:try_start_5e .. :try_end_7b} :catch_7c
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_5e .. :try_end_7b} :catch_7c
    .catch Ljava/lang/InterruptedException; {:try_start_5e .. :try_end_7b} :catch_13c
    .catchall {:try_start_5e .. :try_end_7b} :catchall_13a
    ...
    :try_end_121
    .catch Ljava/lang/InterruptedException; {:try_start_7d .. :try_end_121} :catch_13c
    .catchall {:try_start_7d .. :try_end_121} :catchall_13a
    ...
    throw v2
    :try_end_13a
    .catch Ljava/lang/InterruptedException; {:try_start_12e .. :try_end_13a} :catch_13c
    .catchall {:try_start_12e .. :try_end_13a} :catchall_13a
    ...
    :try_end_140
    .catchall {:try_start_13d .. :try_end_140} :catchall_13a
