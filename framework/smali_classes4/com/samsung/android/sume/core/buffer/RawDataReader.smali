...
.method public constructor <init>(Lcom/samsung/android/sume/core/buffer/MediaBuffer;)V
    .registers 5
...
.method private getRawDataRead(Lcom/samsung/android/sume/core/types/DataType;Ljava/nio/ByteBuffer;)Ljava/util/function/Supplier;
    .registers 5
...
.method private getRawDataReadByIndex(Lcom/samsung/android/sume/core/types/DataType;Ljava/nio/ByteBuffer;)Ljava/util/function/Function;
    .registers 5
    .param p1, "dataType"    # Lcom/samsung/android/sume/core/types/DataType;
    .param p2, "byteBuffer"    # Ljava/nio/ByteBuffer;
    .annotation system Ldalvik/annotation/Signature;
...
.method static synthetic lambda$getRawDataRead$0(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    .registers 2
...
.method static synthetic lambda$getRawDataRead$1(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    .registers 2
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
...
.method static synthetic lambda$getRawDataRead$2(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    .registers 3
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
...
.method static synthetic lambda$getRawDataRead$3(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    .registers 2
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
...
.method static synthetic lambda$getRawDataReadByIndex$4(Ljava/nio/ByteBuffer;Ljava/lang/Integer;)Ljava/lang/Object;
    .registers 4
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
...
.method static synthetic lambda$getRawDataReadByIndex$5(Ljava/nio/ByteBuffer;Ljava/lang/Integer;)Ljava/lang/Object;
    .registers 4
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
    .param p1, "index"    # Ljava/lang/Integer;
...
.method static synthetic lambda$getRawDataReadByIndex$6(Ljava/nio/ByteBuffer;Ljava/lang/Integer;)Ljava/lang/Object;
    .registers 4
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
    .param p1, "index"    # Ljava/lang/Integer;
...
.method static synthetic lambda$getRawDataReadByIndex$7(Ljava/nio/ByteBuffer;Ljava/lang/Integer;)Ljava/lang/Object;
    .registers 4
    .param p0, "byteBuffer"    # Ljava/nio/ByteBuffer;
    .param p1, "index"    # Ljava/lang/Integer;
...
.method synthetic lambda$new$8$com-samsung-android-sume-core-buffer-RawDataReader(Lcom/samsung/android/sume/core/format/MediaFormat;Ljava/nio/ByteBuffer;)Ljava/util/function/Supplier;
    .registers 4
...
.method synthetic lambda$new$9$com-samsung-android-sume-core-buffer-RawDataReader(Lcom/samsung/android/sume/core/format/MediaFormat;Ljava/nio/ByteBuffer;)Ljava/util/function/Function;
    .registers 4
    .param p1, "format"    # Lcom/samsung/android/sume/core/format/MediaFormat;
