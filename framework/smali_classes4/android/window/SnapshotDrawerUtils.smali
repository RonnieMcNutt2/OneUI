...
.field private static final TAG:Ljava/lang/String; = "SnapshotDrawerUtils"

.field private static final sBackgroundPaint:Landroid/graphics/Paint;

.field private static final sSnapshotMatrix:Landroid/graphics/Matrix;

.field private static final sTmpDstFrame:Landroid/graphics/RectF;

.field private static final sTmpFloat9:[F

.field private static final sTmpSnapshotSize:Landroid/graphics/RectF;


# direct methods
.method static bridge synthetic -$$Nest$sfgetsBackgroundPaint()Landroid/graphics/Paint;
    .registers 1
...
.method static bridge synthetic -$$Nest$sfgetsSnapshotMatrix()Landroid/graphics/Matrix;
    .registers 1
...
.method static bridge synthetic -$$Nest$sfgetsTmpDstFrame()Landroid/graphics/RectF;
    .registers 1
...
.method static bridge synthetic -$$Nest$sfgetsTmpFloat9()[F
    .registers 1
...
.method static bridge synthetic -$$Nest$sfgetsTmpSnapshotSize()Landroid/graphics/RectF;
    .registers 1
...
.method static bridge synthetic -$$Nest$smisAspectRatioMatch(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    .registers 2
...
.method public static createLayoutParameters(Landroid/window/StartingWindowInfo;Ljava/lang/CharSequence;IILandroid/os/IBinder;)Landroid/view/WindowManager$LayoutParams;
    .registers 14
...
.method public static drawSnapshotOnSurface(Landroid/window/StartingWindowInfo;Landroid/view/WindowManager$LayoutParams;Landroid/view/SurfaceControl;Landroid/window/TaskSnapshot;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/InsetsState;Z)V
    .registers 23
    .param p0, "info"    # Landroid/window/StartingWindowInfo;
...
.method public static getOrCreateTaskDescription(Landroid/app/ActivityManager$RunningTaskInfo;)Landroid/app/ActivityManager$TaskDescription;
    .registers 3
...
.method private static isAspectRatioMatch(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    .registers 6
...
.method public static isAspectRatioMatch(Landroid/graphics/Rect;Landroid/window/TaskSnapshot;)Z
    .registers 7
    .param p0, "frame"    # Landroid/graphics/Rect;
