...
# static fields
.field private static final BIDI_LEVEL_MASK:I = 0x3f80000

.field private static final BIDI_LEVEL_SHIFT:I = 0x13
...
.field public static final FLAG_CHARACTER_LINEFEED:I = 0x2

.field public static final FLAG_CHARACTER_PUNCTUATION:I = 0x4

.field public static final FLAG_CHARACTER_WHITESPACE:I = 0x1

.field private static final FLAG_GRAPHEME_SEGMENT_END:I = 0x4000000

.field private static final FLAG_GRAPHEME_SEGMENT_START:I = 0x8000000

.field public static final FLAG_LINE_IS_RTL:I = 0x8

.field private static final FLAG_LINE_SEGMENT_END:I = 0x40000000

.field private static final FLAG_LINE_SEGMENT_START:I = -0x80000000

.field private static final FLAG_WORD_SEGMENT_END:I = 0x10000000

.field private static final FLAG_WORD_SEGMENT_START:I = 0x20000000

.field private static final KNOWN_CHARACTER_FLAGS:I = 0xf

.field private static final TEXT_BOUNDS_INFO_KEY:Ljava/lang/String; = "android.view.inputmethod.TextBoundsInfo"


# instance fields
.field private final mCharacterBounds:[F

.field private final mEnd:I

.field private final mGraphemeSegmentFinder:Landroid/text/SegmentFinder;

.field private final mInternalCharacterFlags:[I

.field private final mLineSegmentFinder:Landroid/text/SegmentFinder;

.field private final mMatrixValues:[F

.field private final mStart:I

.field private final mWordSegmentFinder:Landroid/text/SegmentFinder;


# direct methods
.method static bridge synthetic -$$Nest$smisLineDirectionFlagConsistent([ILandroid/text/SegmentFinder;II)Z
    .registers 4
...
.method synthetic constructor <init>(Landroid/os/Parcel;Landroid/view/inputmethod/TextBoundsInfo-IA;)V
    .registers 3
...
.method private constructor <init>(Landroid/view/inputmethod/TextBoundsInfo$Builder;)V
    .registers 7
...
.method synthetic constructor <init>(Landroid/view/inputmethod/TextBoundsInfo$Builder;Landroid/view/inputmethod/TextBoundsInfo-IA;)V
    .registers 3
...
.method public static createFromBundle(Landroid/os/Bundle;)Landroid/view/inputmethod/TextBoundsInfo;
    .registers 3
...
.method private static decodeSegmentFinder([IIIII)Landroid/text/SegmentFinder;
    .registers 10
    .param p0, "flags"    # [I
...
.method private static encodeSegmentFinder([IIIIILandroid/text/SegmentFinder;)V
    .registers 11
    .param p0, "flags"    # [I
    .param p1, "segmentStartFlag"    # I
    .param p2, "segmentEndFlag"    # I
...
.method private getBoundsForRange(IILandroid/graphics/RectF;)V
    .registers 9
    .param p1, "start"    # I
    .param p2, "end"    # I
...
.method private getCursorHorizontalPosition(IIIFF)F
    .registers 14
    .param p1, "index"    # I
...
.method private getEndForRectWithinLine(IILandroid/graphics/RectF;Landroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)I
    .registers 20
...
.method private getEndForRectWithinRun(IILandroid/graphics/RectF;Landroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)I
    .registers 13
    .param p1, "runStart"    # I
    .param p2, "runEnd"    # I
    .param p3, "area"    # Landroid/graphics/RectF;
...
.method private getLineInfo(F[ILandroid/graphics/RectF;)V
    .registers 20
    .param p1, "y"    # F
...
.method private getStartForRectWithinLine(IILandroid/graphics/RectF;Landroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)I
    .registers 22
    .param p1, "lineStart"    # I
    .param p2, "lineEnd"    # I
    .param p3, "area"    # Landroid/graphics/RectF;
...
.method private getStartForRectWithinRun(IILandroid/graphics/RectF;Landroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)I
    .registers 13
    .param p1, "runStart"    # I
    .param p2, "runEnd"    # I
    .param p3, "area"    # Landroid/graphics/RectF;
...
.method private static isLineDirectionFlagConsistent([ILandroid/text/SegmentFinder;II)Z
    .registers 15
...
.method private primaryIsTrailingPrevious(III)Z
    .registers 9
    .param p1, "offset"    # I
    .param p2, "lineStart"    # I
    .param p3, "lineEnd"    # I
...
.method private static verticalDistance(Landroid/graphics/RectF;F)F
    .registers 3
...
.method public getCharacterBidiLevel(I)I
    .registers 5
    .param p1, "index"    # I
...
.method public getCharacterBounds(ILandroid/graphics/RectF;)V
    .registers 9
    .param p1, "index"    # I
...
.method public getCharacterFlags(I)I
    .registers 5
    .param p1, "index"    # I
...
.method public getGraphemeSegmentFinder()Landroid/text/SegmentFinder;
    .registers 2
...
.method public getLineSegmentFinder()Landroid/text/SegmentFinder;
    .registers 2
...
.method public getOffsetForPosition(FF)I
    ...
    :goto_4c
    if-eq v15, v10, :cond_76

    if-ge v15, v14, :cond_76

    .line 391
    if-lt v15, v11, :cond_6f
...
.method public getRangeForRect(Landroid/graphics/RectF;Landroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)[I
    .registers 15
...
.method public getWordSegmentFinder()Landroid/text/SegmentFinder;
    .registers 2
