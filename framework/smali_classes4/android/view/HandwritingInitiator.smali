...
# instance fields
.field private mCachedHoverTarget:Ljava/lang/ref/WeakReference;
...
.field private mShowHoverIconForConnectedView:Z
...
.method private static contains(Landroid/graphics/Rect;FFFFFF)Z
    .registers 8
...
.method private static distance(Landroid/graphics/Rect;FF)F
    .registers 10
    .param p0, "rect"    # Landroid/graphics/Rect;
    .param p1, "x"    # F
    .param p2, "y"    # F
...
.method private findBestCandidateView(FFZ)Landroid/view/View;
    .registers 21
    .param p1, "x"    # F
    .param p2, "y"    # F
    .param p3, "isHover"    # Z
...
.method private findHoverView(Landroid/view/MotionEvent;)Landroid/view/View;
    .registers 13
...
.method private getCachedHoverTarget()Landroid/view/View;
    .registers 2
...
.method private isInHandwritingArea(Landroid/graphics/Rect;FFLandroid/view/View;Z)Z
    .registers 24
...
.method private static requestFocusWithoutReveal(Landroid/view/View;)V
    .registers 2
    .param p0, "view"    # Landroid/view/View;
...
.method private static shouldTriggerStylusHandwritingForView(Landroid/view/View;)Z
    .registers 2
    .param p0, "view"    # Landroid/view/View;
...
# virtual methods
.method public onDelegateViewFocused(Landroid/view/View;)V
    .registers 3
...
.method public onResolvePointerIcon(Landroid/content/Context;Landroid/view/MotionEvent;)Landroid/view/PointerIcon;
    .registers 7
...
.method public tryAcceptStylusHandwritingDelegation(Landroid/view/View;)Z
    .registers 6
    .param p1, "view"    # Landroid/view/View;
