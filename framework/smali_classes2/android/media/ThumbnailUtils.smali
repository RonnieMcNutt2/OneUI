...
.method public static createVideoThumbnail(Ljava/io/File;Landroid/util/Size;Landroid/os/CancellationSignal;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0}, Landroid/media/MediaMetadataRetriever;-><init>()V
    :try_end_14
    .catch Ljava/lang/RuntimeException; {:try_start_f .. :try_end_14} :catch_a6
    ...
    move-result-object v4
    :try_end_2a
    .catchall {:try_start_15 .. :try_end_2a} :catchall_9a

    .line 398
    :try_start_2a
    invoke-virtual {v11}, Landroid/media/MediaMetadataRetriever;->close()V
    :try_end_2d
    .catch Ljava/lang/RuntimeException; {:try_start_2a .. :try_end_2d} :catch_a6
    ...
    if-le v4, v13, :cond_7d

    invoke-virtual/range {p1 .. p1}, Landroid/util/Size;->getHeight()I

    move-result v4

    if-le v4, v14, :cond_7d
    ...
    :try_end_79
    .catchall {:try_start_2e .. :try_end_79} :catchall_9a

    .line 398
    :try_start_79
    invoke-virtual {v11}, Landroid/media/MediaMetadataRetriever;->close()V
    :try_end_7c
    .catch Ljava/lang/RuntimeException; {:try_start_79 .. :try_end_7c} :catch_a6
    ...
    invoke-virtual {v11}, Landroid/media/MediaMetadataRetriever;->close()V
    :try_end_99
    .catch Ljava/lang/RuntimeException; {:try_start_96 .. :try_end_99} :catch_a6
