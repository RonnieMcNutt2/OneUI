...
# static fields
.field private static final synthetic $VALUES:[Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum AZERTY:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum COLEMAK:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum DVORAK:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum EXTENDED:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum QWERTY:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum QWERTZ:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum TURKISH_F:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum TURKISH_Q:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field public static final enum UNDEFINED:Landroid/hardware/input/KeyboardLayout$LayoutType;

.field private static final VALUE_TO_ENUM_MAP:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Integer;",
...
.field public static final enum WORKMAN:Landroid/hardware/input/KeyboardLayout$LayoutType;
...
# direct methods
.method private static synthetic $values()[Landroid/hardware/input/KeyboardLayout$LayoutType;
    .registers 10
...
.method static bridge synthetic -$$Nest$fgetmValue(Landroid/hardware/input/KeyboardLayout$LayoutType;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$mgetName(Landroid/hardware/input/KeyboardLayout$LayoutType;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$mgetValue(Landroid/hardware/input/KeyboardLayout$LayoutType;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$smof(I)Landroid/hardware/input/KeyboardLayout$LayoutType;
    .registers 1
...
.method private static of(I)Landroid/hardware/input/KeyboardLayout$LayoutType;
    .registers 4
    .param p0, "value"    # I
...
.method public static valueOf(Ljava/lang/String;)Landroid/hardware/input/KeyboardLayout$LayoutType;
    .registers 2
...
.method public static values()[Landroid/hardware/input/KeyboardLayout$LayoutType;
    .registers 1
