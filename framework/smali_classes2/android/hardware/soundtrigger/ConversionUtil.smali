...
.method public static aidl2apiPhrase(Landroid/media/soundtrigger/Phrase;)Landroid/hardware/soundtrigger/SoundTrigger$Keyphrase;
    .registers 8
...
.method public static aidl2apiPhraseRecognitionEvent(IILandroid/media/soundtrigger_middleware/PhraseRecognitionEventSys;)Landroid/hardware/soundtrigger/SoundTrigger$RecognitionEvent;
    .registers 22
...
.method public static aidl2apiRecognitionConfig(Landroid/media/soundtrigger/RecognitionConfig;)Landroid/hardware/soundtrigger/SoundTrigger$RecognitionConfig;
    .registers 10
...
.method public static aidl2apiRecognitionEvent(IILandroid/media/soundtrigger_middleware/RecognitionEventSys;)Landroid/hardware/soundtrigger/SoundTrigger$RecognitionEvent;
    .registers 23
    .param p0, "modelHandle"    # I
    .param p1, "captureSession"    # I
...
.method public static byteArrayToSharedMemory([BLjava/lang/String;)Landroid/os/ParcelFileDescriptor;
    .registers 5
    .param p0, "data"    # [B
...
.method public static sharedMemoryToByteArray(Landroid/os/ParcelFileDescriptor;I)[B
    .registers 5
    ...
    move-result-object v0
    :try_end_9
    .catch Landroid/system/ErrnoException; {:try_start_5 .. :try_end_9} :catch_34
    ...
    invoke-virtual {v0}, Landroid/os/SharedMemory;->close()V
    :try_end_27
    .catch Landroid/system/ErrnoException; {:try_start_24 .. :try_end_27} :catch_34
    ...
    throw v1
    :try_end_34
    .catch Landroid/system/ErrnoException; {:try_start_30 .. :try_end_34} :catch_34
