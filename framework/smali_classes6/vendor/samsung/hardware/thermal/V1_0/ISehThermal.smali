...
# static fields
.field public static final kInterfaceName:Ljava/lang/String; = "vendor.samsung.hardware.thermal@1.0::ISehThermal"


# direct methods
.method public static asInterface(Landroid/os/IHwBinder;)Lvendor/samsung/hardware/thermal/V1_0/ISehThermal;
    .registers 8
...
.method public static castFrom(Landroid/os/IHwInterface;)Lvendor/samsung/hardware/thermal/V1_0/ISehThermal;
    .registers 2
...
.method public static getService()Lvendor/samsung/hardware/thermal/V1_0/ISehThermal;
    .registers 1
...
.method public static getService(Ljava/lang/String;)Lvendor/samsung/hardware/thermal/V1_0/ISehThermal;
    .registers 2
...
.method public static getService(Ljava/lang/String;Z)Lvendor/samsung/hardware/thermal/V1_0/ISehThermal;
    .registers 3
    .param p0, "serviceName"    # Ljava/lang/String;
    .param p1, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public static getService(Z)Lvendor/samsung/hardware/thermal/V1_0/ISehThermal;
    .registers 2
    .param p0, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public abstract sehGetTemperatures(Lvendor/samsung/hardware/thermal/V1_0/ISehThermal$sehGetTemperaturesCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract sehGetTypeTemperatures(ILvendor/samsung/hardware/thermal/V1_0/ISehThermal$sehGetTypeTemperaturesCallback;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract sehRegisterThermalChangedCallback(Lvendor/samsung/hardware/thermal/V1_0/ISehThermalChangedCallback;)Landroid/hardware/thermal/V1_0/ThermalStatus;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract sehUnregisterThermalChangedCallback(Lvendor/samsung/hardware/thermal/V1_0/ISehThermalChangedCallback;)Landroid/hardware/thermal/V1_0/ThermalStatus;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
