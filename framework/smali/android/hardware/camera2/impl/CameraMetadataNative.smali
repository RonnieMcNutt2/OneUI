...
.method static bridge synthetic -$$Nest$mgetColorSpaceProfiles(Landroid/hardware/camera2/impl/CameraMetadataNative;)Landroid/hardware/camera2/params/ColorSpaceProfiles;
    .registers 1
...
.method static bridge synthetic -$$Nest$msetLensShadingMap(Landroid/hardware/camera2/impl/CameraMetadataNative;Landroid/hardware/camera2/params/LensShadingMap;)Z
    .registers 2
...
.method private getColorSpaceProfiles()Landroid/hardware/camera2/params/ColorSpaceProfiles;
    .registers 3
...
.method private getFaces()[Landroid/hardware/camera2/params/Face;
    ...
    if-gt v8, v12, :cond_14f

    aget-byte v8, v2, v7

    if-lt v8, v10, :cond_14f
    ...
    if-gt v8, v12, :cond_17e

    aget-byte v8, v2, v7

    if-lt v8, v10, :cond_17e
    ...
    .restart local v7    # "i":I
    :goto_183
    if-ge v7, v6, :cond_1d8

    .line 1033
    aget-byte v11, v2, v7

    if-gt v11, v12, :cond_1d5

    aget-byte v11, v2, v7

    if-lt v11, v10, :cond_1d5
...
.method private isCroppedRawSupported()Z
    .registers 9
...
.method private setLensShadingMap(Landroid/hardware/camera2/params/LensShadingMap;)Z
    .registers 6
