...
# static fields
.field private static final BINDER_EXECUTOR:Ljava/util/concurrent/Executor;


# instance fields
.field private final mRemoteDevice:Landroid/hardware/camera2/DeviceInjectorSession$RemoteDevice;

.field final synthetic this$0:Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl;


# direct methods
.method public static synthetic $r8$lambda$6m4Wic_7Szs1VUsLtUg_DxIW_18(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;Landroid/hardware/IRemoteDeviceCallback;)Ljava/lang/Object;
    .registers 2
...
.method public static synthetic $r8$lambda$BW0yMB8PItKH2cPwsc4ZFOfea7o(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;Landroid/view/Surface;)Ljava/lang/Integer;
    .registers 2
...
.method public static synthetic $r8$lambda$CKULrrkct2WM9lUDeJkfdImVsjM(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;Ljava/lang/String;I)Ljava/lang/String;
    .registers 3
...
.method public static synthetic $r8$lambda$JWBOL7cPZu1xj6EFBkDvNhSjzGs(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;I)Ljava/lang/Object;
    .registers 2
...
.method public static synthetic $r8$lambda$L6jWetzBYbDTJErCdj4z67lM7pw(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;Landroid/hardware/camera2/DeviceInjectorSession$CharacteristicBuilder;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    .registers 2
...
.method public static synthetic $r8$lambda$R3wpylawF2806i-jK0FI86Pq1vA(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;Landroid/hardware/camera2/CaptureRequest$Builder;[IZ)Ljava/lang/Object;
    .registers 4
...
.method public static synthetic $r8$lambda$fRI6k48peAjFDg20RzaUWeOtJQw(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;)Ljava/lang/Object;
    .registers 1
...
.method public static synthetic $r8$lambda$h8fG_eRmuLrl2PUfsR2TxhC0TFI(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;Landroid/hardware/camera2/CaptureRequest$Builder;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    .registers 2
...
.method public static synthetic $r8$lambda$qEsWg9yxOYHb6FUaHKx8lye8ZJU(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl$DeviceInjectorRemoteDevice;)Ljava/lang/Object;
    .registers 1
...
.method public constructor <init>(Landroid/hardware/camera2/impl/DeviceInjectorSessionImpl;Landroid/hardware/camera2/DeviceInjectorSession$RemoteDevice;)V
    .registers 3
...
.method private executeWithCleanIdentity(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    .registers 8
...
.method private synthetic lambda$clearRequest$7()Ljava/lang/Object;
    .registers 2
...
.method private synthetic lambda$close$9()Ljava/lang/Object;
    .registers 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private synthetic lambda$createDefaultRequest$5(Landroid/hardware/camera2/CaptureRequest$Builder;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    .registers 3
...
.method private synthetic lambda$createStream$3(Landroid/view/Surface;)Ljava/lang/Integer;
    .registers 4
...
.method private synthetic lambda$deleteStream$4(I)Ljava/lang/Object;
    .registers 3
    .param p1, "streamId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method static synthetic lambda$executeWithCleanIdentity$0(Ljava/util/concurrent/CompletableFuture;Ljava/util/concurrent/Callable;)V
    .registers 4
...
.method private synthetic lambda$getCameraCharacteristic$2(Landroid/hardware/camera2/DeviceInjectorSession$CharacteristicBuilder;)Landroid/hardware/camera2/impl/CameraMetadataNative;
    .registers 3
...
.method private synthetic lambda$open$1(Ljava/lang/String;I)Ljava/lang/String;
    .registers 4
...
.method private synthetic lambda$setCallback$8(Landroid/hardware/IRemoteDeviceCallback;)Ljava/lang/Object;
    .registers 4
...
.method private synthetic lambda$submitRequest$6(Landroid/hardware/camera2/CaptureRequest$Builder;[IZ)Ljava/lang/Object;
    .registers 6
    .param p1, "builder"    # Landroid/hardware/camera2/CaptureRequest$Builder;
