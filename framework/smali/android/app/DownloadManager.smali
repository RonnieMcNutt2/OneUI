...
# direct methods
.method static bridge synthetic -$$Nest$sfgetLONG_COLUMNS()Ljava/util/Set;
    .registers 1
...
.method static bridge synthetic -$$Nest$sfgetSEC_COLUMNS()[Ljava/lang/String;
    .registers 1
...
.method public onMediaStoreDownloadsDeleted(Landroid/util/LongSparseArray;)V
    ...
    move-result-object v0
    :try_end_8
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_8} :catch_65
    ...
    :try_end_16
    .catch Landroid/os/RemoteException; {:try_start_13 .. :try_end_16} :catch_65
    ...
    :try_end_53
    .catchall {:try_start_17 .. :try_end_53} :catchall_59
    ...
    invoke-virtual {v0}, Landroid/content/ContentProviderClient;->close()V
    :try_end_58
    .catch Landroid/os/RemoteException; {:try_start_55 .. :try_end_58} :catch_65
    ...
    throw v1
    :try_end_65
    .catch Landroid/os/RemoteException; {:try_start_61 .. :try_end_65} :catch_65
...
.method public rename(Landroid/content/Context;JLjava/lang/String;)Z
    ...
    move-result v10
    :try_end_4c
    .catchall {:try_start_21 .. :try_end_4c} :catchall_157
    ...
    throw v0
    :try_end_173
    .catchall {:try_start_e7 .. :try_end_173} :catchall_157
    ...
    invoke-interface {v8}, Landroid/database/Cursor;->close()V
    :try_end_178
    .catchall {:try_start_175 .. :try_end_178} :catchall_179
...
.method public varargs restartDownload([J)Z
    ...
    move-result v1
    :try_end_14
    .catchall {:try_start_d .. :try_end_14} :catchall_a3
    ...
    move-result v1
    :try_end_22
    .catchall {:try_start_1a .. :try_end_22} :catchall_a3
    ...
    :try_end_32
    .catchall {:try_start_2f .. :try_end_32} :catchall_a3
...
.method public varargs secrestartDownload([J)Z
    ...
    move-result v3
    :try_end_29
    .catchall {:try_start_21 .. :try_end_29} :catchall_82
    ...
    invoke-interface {v0}, Landroid/database/Cursor;->moveToNext()Z
    :try_end_39
    .catchall {:try_start_36 .. :try_end_39} :catchall_82
