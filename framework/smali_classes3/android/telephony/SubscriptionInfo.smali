...
# instance fields
.field private final mAreUiccApplicationsEnabled:Z

.field private final mCardId:I

.field private final mCardString:Ljava/lang/String;

.field private final mCarrierConfigAccessRules:[Landroid/telephony/UiccAccessRule;
...
.field private final mDataRoaming:I

.field private final mDisplayName:Ljava/lang/CharSequence;

.field private final mDisplayNameSource:I

.field private final mEhplmns:[Ljava/lang/String;

.field private final mGroupOwner:Ljava/lang/String;

.field private final mGroupUuid:Landroid/os/ParcelUuid;

.field private final mHplmns:[Ljava/lang/String;
...
.field private final mIsGroupDisabled:Z
...
.field private final mNativeAccessRules:[Landroid/telephony/UiccAccessRule;
...
.field private final mUsageSetting:I


# direct methods
.method static bridge synthetic -$$Nest$fgetmAreUiccApplicationsEnabled(Landroid/telephony/SubscriptionInfo;)Z
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmCardId(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmCardString(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmCarrierConfigAccessRules(Landroid/telephony/SubscriptionInfo;)[Landroid/telephony/UiccAccessRule;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmCarrierId(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmCarrierName(Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmCountryIso(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmDataRoaming(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmDisplayName(Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmDisplayNameSource(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmEhplmns(Landroid/telephony/SubscriptionInfo;)[Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmGroupOwner(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmGroupUuid(Landroid/telephony/SubscriptionInfo;)Landroid/os/ParcelUuid;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmHplmns(Landroid/telephony/SubscriptionInfo;)[Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmIccId(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmIconBitmap(Landroid/telephony/SubscriptionInfo;)Landroid/graphics/Bitmap;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmIconTint(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmId(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmIsEmbedded(Landroid/telephony/SubscriptionInfo;)Z
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmIsGroupDisabled(Landroid/telephony/SubscriptionInfo;)Z
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmIsOpportunistic(Landroid/telephony/SubscriptionInfo;)Z
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmMcc(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmMnc(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmNativeAccessRules(Landroid/telephony/SubscriptionInfo;)[Landroid/telephony/UiccAccessRule;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmNumber(Landroid/telephony/SubscriptionInfo;)Ljava/lang/String;
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmPortIndex(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmProfileClass(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmSimSlotIndex(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmType(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method static bridge synthetic -$$Nest$fgetmUsageSetting(Landroid/telephony/SubscriptionInfo;)I
    .registers 1
...
.method private constructor <init>(Landroid/telephony/SubscriptionInfo$Builder;)V
    .registers 3
...
.method synthetic constructor <init>(Landroid/telephony/SubscriptionInfo$Builder;Landroid/telephony/SubscriptionInfo-IA;)V
    .registers 3
...
.method public static getPrintableId(Ljava/lang/String;)Ljava/lang/String;
    .registers 6
...
.method public semGetProfileClass()I
    .registers 2
