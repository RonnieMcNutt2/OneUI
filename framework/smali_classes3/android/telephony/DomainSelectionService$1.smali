...
# direct methods
.method public static synthetic $r8$lambda$MqIAkV3G1QB8VI5eXK57JUmJwhM(Landroid/telephony/DomainSelectionService$1;Landroid/telephony/DomainSelectionService$SelectionAttributes;Lcom/android/internal/telephony/ITransportSelectorCallback;)V
    .registers 3
...
.method public static synthetic $r8$lambda$r6dZpks9Nbrj5FkMPvrWEZOhMfQ(Landroid/telephony/DomainSelectionService$1;IILandroid/telephony/BarringInfo;)V
    .registers 4
...
.method public static synthetic $r8$lambda$xxU5leUE1khiUr9j9z0kuENuPyg(Landroid/telephony/DomainSelectionService$1;IILandroid/telephony/ServiceState;)V
    .registers 4
...
.method constructor <init>(Landroid/telephony/DomainSelectionService;)V
    .registers 2
...
.method private synthetic lambda$selectDomain$0(Landroid/telephony/DomainSelectionService$SelectionAttributes;Lcom/android/internal/telephony/ITransportSelectorCallback;)V
    .registers 6
...
.method private synthetic lambda$updateBarringInfo$2(IILandroid/telephony/BarringInfo;)V
    .registers 5
    .param p1, "slotId"    # I
    .param p2, "subId"    # I
...
.method private synthetic lambda$updateServiceState$1(IILandroid/telephony/ServiceState;)V
    .registers 5
    .param p1, "slotId"    # I
    .param p2, "subId"    # I
...
# virtual methods
.method public selectDomain(Landroid/telephony/DomainSelectionService$SelectionAttributes;Lcom/android/internal/telephony/ITransportSelectorCallback;)V
    .registers 7
    .param p1, "attr"    # Landroid/telephony/DomainSelectionService$SelectionAttributes;
    .param p2, "callback"    # Lcom/android/internal/telephony/ITransportSelectorCallback;
...
.method public updateBarringInfo(IILandroid/telephony/BarringInfo;)V
    .registers 9
    .param p1, "slotId"    # I
    .param p2, "subId"    # I
    .param p3, "info"    # Landroid/telephony/BarringInfo;
...
.method public updateServiceState(IILandroid/telephony/ServiceState;)V
    .registers 9
    .param p1, "slotId"    # I
    .param p2, "subId"    # I
    .param p3, "serviceState"    # Landroid/telephony/ServiceState;
