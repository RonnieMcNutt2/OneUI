...
# static fields
.field private static final MSG_ADD_CONSUMER:I = 0x1

.field private static final MSG_OVERLAY_CLIENT_READY:I = 0x3

.field private static final MSG_REMOVE_CONSUMER:I = 0x2

.field private static final TAG:Ljava/lang/String; = "DreamOverlayConnection"


# instance fields
.field private final mCallback:Landroid/service/dreams/DreamOverlayConnectionHandler$OverlayConnectionCallback;

.field private mClient:Landroid/service/dreams/IDreamOverlayClient;

.field private final mConnection:Lcom/android/internal/util/PersistentServiceConnection;
...
# direct methods
.method static bridge synthetic -$$Nest$fgetmHandler(Landroid/service/dreams/DreamOverlayConnectionHandler;)Landroid/os/Handler;
    .registers 1
...
.method static bridge synthetic -$$Nest$fputmClient(Landroid/service/dreams/DreamOverlayConnectionHandler;Landroid/service/dreams/IDreamOverlayClient;)V
    .registers 2
...
.method static bridge synthetic -$$Nest$monAddConsumer(Landroid/service/dreams/DreamOverlayConnectionHandler;Ljava/util/function/Consumer;)V
    .registers 2
...
.method static bridge synthetic -$$Nest$monOverlayClientReady(Landroid/service/dreams/DreamOverlayConnectionHandler;Landroid/service/dreams/IDreamOverlayClient;)V
    .registers 2
...
.method static bridge synthetic -$$Nest$monRemoveConsumer(Landroid/service/dreams/DreamOverlayConnectionHandler;Ljava/util/function/Consumer;)V
    .registers 2
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Landroid/content/Intent;III)V
    .registers 15
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Landroid/content/Intent;IIILandroid/service/dreams/DreamOverlayConnectionHandler$Injector;)V
    .registers 18
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "looper"    # Landroid/os/Looper;
    .param p3, "serviceIntent"    # Landroid/content/Intent;
...
.method private onAddConsumer(Ljava/util/function/Consumer;)V
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private onOverlayClientReady(Landroid/service/dreams/IDreamOverlayClient;)V
    .registers 5
...
.method private onRemoveConsumer(Ljava/util/function/Consumer;)V
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
