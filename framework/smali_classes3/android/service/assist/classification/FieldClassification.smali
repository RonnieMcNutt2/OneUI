...
.field private final mGroupHints:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Ljava/lang/String;",
...
.field private final mHints:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Ljava/lang/String;",
...
.method public constructor <init>(Landroid/view/autofill/AutofillId;Ljava/util/Set;)V
    .registers 4
...
.method public constructor <init>(Landroid/view/autofill/AutofillId;Ljava/util/Set;Ljava/util/Set;)V
    .registers 4
    .param p1, "autofillId"    # Landroid/view/autofill/AutofillId;
...
.method static unparcelGroupHints(Landroid/os/Parcel;)Ljava/util/Set;
    .registers 3
...
.method static unparcelHints(Landroid/os/Parcel;)Ljava/util/Set;
    .registers 3
    .param p0, "in"    # Landroid/os/Parcel;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public getGroupHints()Ljava/util/Set;
    .registers 2
    .annotation runtime Landroid/annotation/SystemApi;
    .end annotation
...
.method public getHints()Ljava/util/Set;
    .registers 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method parcelGroupHints(Landroid/os/Parcel;I)V
    .registers 5
...
.method parcelHints(Landroid/os/Parcel;I)V
    .registers 5
    .param p1, "dest"    # Landroid/os/Parcel;
    .param p2, "flags"    # I
