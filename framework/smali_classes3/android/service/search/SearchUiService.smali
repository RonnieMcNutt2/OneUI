...
.field private final mSessionEmptyQueryResultCallbacks:Landroid/util/ArrayMap;
...
# direct methods
.method public static synthetic $r8$lambda$YSvrZbHOFJyjio1ppbWKhKTZ3QI(Landroid/service/search/SearchUiService;Ljava/util/ArrayList;Landroid/service/search/SearchUiService$CallbackWrapper;)V
    .registers 3
...
.method public static synthetic $r8$lambda$zlqziQZ8bNuYlXsY2eWTRpPV07w(Landroid/service/search/SearchUiService;Ljava/util/ArrayList;Landroid/service/search/SearchUiService$CallbackWrapper;)V
    .registers 3
...
.method static bridge synthetic -$$Nest$mdoRegisterEmptyQueryResultUpdateCallback(Landroid/service/search/SearchUiService;Landroid/app/search/SearchSessionId;Landroid/app/search/ISearchCallback;)V
    .registers 3
...
.method static bridge synthetic -$$Nest$mdoUnregisterEmptyQueryResultUpdateCallback(Landroid/service/search/SearchUiService;Landroid/app/search/SearchSessionId;Landroid/app/search/ISearchCallback;)V
    .registers 3
...
.method private doRegisterEmptyQueryResultUpdateCallback(Landroid/app/search/SearchSessionId;Landroid/app/search/ISearchCallback;)V
    .registers 7
    .param p1, "sessionId"    # Landroid/app/search/SearchSessionId;
...
.method private doUnregisterEmptyQueryResultUpdateCallback(Landroid/app/search/SearchSessionId;Landroid/app/search/ISearchCallback;)V
    .registers 6
    .param p1, "sessionId"    # Landroid/app/search/SearchSessionId;
    .param p2, "callback"    # Landroid/app/search/ISearchCallback;
...
.method private findCallbackWrapper(Ljava/util/ArrayList;Landroid/app/search/ISearchCallback;)Landroid/service/search/SearchUiService$CallbackWrapper;
    .registers 5
    .param p2, "callback"    # Landroid/app/search/ISearchCallback;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private synthetic lambda$doRegisterEmptyQueryResultUpdateCallback$0(Ljava/util/ArrayList;Landroid/service/search/SearchUiService$CallbackWrapper;)V
    .registers 3
...
.method private synthetic lambda$doRegisterEmptyQueryResultUpdateCallback$1(Ljava/util/ArrayList;Landroid/service/search/SearchUiService$CallbackWrapper;)V
    .registers 5
    .param p1, "callbacks"    # Ljava/util/ArrayList;
    .param p2, "callbackWrapper"    # Landroid/service/search/SearchUiService$CallbackWrapper;
...
.method private removeCallbackWrapper(Ljava/util/ArrayList;Landroid/service/search/SearchUiService$CallbackWrapper;)V
    .registers 4
...
.method public onStartUpdateEmptyQueryResult()V
    .registers 1
...
.method public onStopUpdateEmptyQueryResult()V
    .registers 1
...
.method public final updateEmptyQueryResult(Landroid/app/search/SearchSessionId;Ljava/util/List;)V
    .registers 6
    .param p1, "sessionId"    # Landroid/app/search/SearchSessionId;
    .annotation system Ldalvik/annotation/Signature;
        value = {
