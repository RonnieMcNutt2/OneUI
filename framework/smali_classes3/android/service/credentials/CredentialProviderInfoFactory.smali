...
.field private static final TAG:Ljava/lang/String; = "CredentialProviderInfoFactory"

.field private static final TAG_CAPABILITIES:Ljava/lang/String; = "capabilities"

.field private static final TAG_CAPABILITY:Ljava/lang/String; = "capability"

.field private static final TAG_CREDENTIAL_PROVIDER:Ljava/lang/String; = "credential-provider"
...
.method public static create(Landroid/content/Context;Landroid/content/ComponentName;IZ)Landroid/credentials/CredentialProviderInfo;
    .registers 10
...
.method public static create(Landroid/content/Context;Landroid/content/pm/ServiceInfo;ZZZZ)Landroid/credentials/CredentialProviderInfo;
    .registers 9
    .param p0, "context"    # Landroid/content/Context;
...
.method public static createForTests(Landroid/content/pm/ServiceInfo;Ljava/lang/CharSequence;ZZLjava/util/List;)Landroid/credentials/CredentialProviderInfo;
    .registers 6
...
.method private static extractXmlMetadata(Landroid/content/Context;Landroid/credentials/CredentialProviderInfo$Builder;Landroid/content/pm/ServiceInfo;Landroid/content/pm/PackageManager;Landroid/content/res/Resources;)Landroid/credentials/CredentialProviderInfo$Builder;
    .registers 12
    .param p0, "context"    # Landroid/content/Context;
    ...
    :try_end_29
    .catch Ljava/io/IOException; {:try_start_13 .. :try_end_29} :catch_61
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_13 .. :try_end_29} :catch_61
    ...
    :try_end_3a
    .catch Ljava/lang/Exception; {:try_start_2a .. :try_end_3a} :catch_42
    ...
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3c .. :try_end_3f} :catch_61
    ...
    :try_end_60
    .catch Ljava/io/IOException; {:try_start_4b .. :try_end_60} :catch_61
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_4b .. :try_end_60} :catch_61
...
.method private static getAvailableSystemServiceInfos(Landroid/content/Context;IZ)Ljava/util/List;
    .registers 12
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "userId"    # I
    ...
    invoke-interface {v0, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_5c
    .catch Ljava/lang/SecurityException; {:try_start_43 .. :try_end_5c} :catch_5f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_43 .. :try_end_5c} :catch_5f
...
.method public static getAvailableSystemServices(Landroid/content/Context;IZLjava/util/Set;)Ljava/util/List;
    .registers 14
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "userId"    # I
    .param p2, "disableSystemAppVerificationForTests"    # Z
...
.method public static getCredentialProviderServices(Landroid/content/Context;IILjava/util/Set;Ljava/util/Set;)Ljava/util/List;
    .registers 10
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "userId"    # I
...
.method public static getCredentialProviderServicesForTesting(Landroid/content/Context;IILjava/util/Set;Ljava/util/Set;)Ljava/util/List;
    .registers 10
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "userId"    # I
    .param p2, "providerFilter"    # I
...
.method private static getDeviceManagerPolicy(Landroid/content/Context;I)Landroid/app/admin/PackagePolicy;
    .registers 6
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "userId"    # I
...
.method private static getUserProviders(Landroid/content/Context;IZLjava/util/Set;Ljava/util/Set;)Ljava/util/List;
    .registers 21
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "userId"    # I
    .param p2, "disableSystemAppVerificationForTests"    # Z
    ...
    move-result-object v0
    :try_end_40
    .catch Ljava/lang/Exception; {:try_start_3c .. :try_end_40} :catch_6b
    ...
    move-result-object v0
    :try_end_4e
    .catch Ljava/lang/Exception; {:try_start_42 .. :try_end_4e} :catch_69
...
.method private static isSystemProviderWithValidPermission(Landroid/content/pm/ServiceInfo;Landroid/content/Context;)Z
    .registers 4
    .param p0, "serviceInfo"    # Landroid/content/pm/ServiceInfo;
...
.method private static isValidSystemProvider(Landroid/content/Context;Landroid/content/pm/ServiceInfo;Z)Z
    .registers 6
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "serviceInfo"    # Landroid/content/pm/ServiceInfo;
    .param p2, "disableSystemAppVerificationForTests"    # Z
...
.method private static parseXmlProviderInnerCapabilities(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Ljava/util/List;
    .registers 7
...
.method private static parseXmlProviderOuterCapabilities(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Ljava/util/Set;
    .registers 7
    .param p0, "parser"    # Lorg/xmlpull/v1/XmlPullParser;
    .param p1, "resources"    # Landroid/content/res/Resources;
    .annotation system Ldalvik/annotation/Signature;
...
.method private static populateMetadata(Landroid/content/Context;Landroid/content/pm/ServiceInfo;)Landroid/credentials/CredentialProviderInfo$Builder;
    .registers 9
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "serviceInfo"    # Landroid/content/pm/ServiceInfo;
    ...
    move-result-object v5
    :try_end_36
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_30 .. :try_end_36} :catch_38
...
.method private static verifyProviderPermission(Landroid/content/pm/ServiceInfo;)V
    .registers 4
    .param p0, "serviceInfo"    # Landroid/content/pm/ServiceInfo;
    .annotation system Ldalvik/annotation/Throws;
        value = {
