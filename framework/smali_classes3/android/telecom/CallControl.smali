...
# static fields
.field private static final INTERFACE_ERROR_MSG:Ljava/lang/String; = "Call Control is not available"
...
.field private final mServerInterface:Lcom/android/internal/telecom/ICallControl;


# direct methods
.method static bridge synthetic -$$Nest$mgetTransactionException(Landroid/telecom/CallControl;Landroid/os/Bundle;)Landroid/telecom/CallException;
    .registers 2
...
.method public constructor <init>(Ljava/lang/String;Lcom/android/internal/telecom/ICallControl;Lcom/android/internal/telecom/ClientTransactionalServiceRepository;Landroid/telecom/PhoneAccountHandle;)V
    .registers 5
...
.method private getTransactionException(Landroid/os/Bundle;)Landroid/telecom/CallException;
    .registers 5
...
.method private validateDisconnectCause(Landroid/telecom/DisconnectCause;)V
    .registers 6
...
.method private validateVideoState(I)V
    .registers 5
...
# virtual methods
.method public answer(ILjava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    .registers 8
    .param p1, "videoState"    # I
...
.method public disconnect(Landroid/telecom/DisconnectCause;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    .registers 8
    .param p1, "disconnectCause"    # Landroid/telecom/DisconnectCause;
    .param p2, "executor"    # Ljava/util/concurrent/Executor;
    .annotation system Ldalvik/annotation/Signature;
...
.method public getCallId()Landroid/os/ParcelUuid;
    .registers 2
...
.method public setActive(Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    .registers 7
...
.method public setInactive(Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    .registers 7
    .param p1, "executor"    # Ljava/util/concurrent/Executor;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public startCallStreaming(Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    .registers 7
    .param p1, "executor"    # Ljava/util/concurrent/Executor;
    .annotation system Ldalvik/annotation/Signature;
        value = {
