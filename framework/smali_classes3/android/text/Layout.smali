...
.field public static final INCLUSION_STRATEGY_ANY_OVERLAP:Landroid/text/Layout$TextInclusionStrategy;

.field public static final INCLUSION_STRATEGY_CONTAINS_ALL:Landroid/text/Layout$TextInclusionStrategy;

.field public static final INCLUSION_STRATEGY_CONTAINS_CENTER:Landroid/text/Layout$TextInclusionStrategy;
...
.method private fillHorizontalBoundsForLine(I[F)V
    .registers 25
    .param p1, "line"    # I
...
.method private static getEndOffsetForAreaWithinRun(Landroid/graphics/RectF;IIII[FIIFFZLandroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)I
    .registers 28
...
.method private static getStartOffsetForAreaWithinRun(Landroid/graphics/RectF;IIII[FIIFFZLandroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;)I
    .registers 28
    .param p0, "area"    # Landroid/graphics/RectF;
    .param p1, "lineTop"    # I
    .param p2, "lineBottom"    # I
...
.method private getStartOrEndOffsetForAreaWithinLine(ILandroid/graphics/RectF;Landroid/text/SegmentFinder;Landroid/text/Layout$TextInclusionStrategy;Z)I
    .registers 36
    .param p1, "line"    # I
...
.method static synthetic lambda$addSelectionPath$3(Landroid/graphics/Path;FFFFI)V
    .registers 13
...
.method static synthetic lambda$getSelectionPath$2(Landroid/graphics/Path;FFFFI)V
    .registers 12
    .param p0, "dest"    # Landroid/graphics/Path;
    .param p1, "left"    # F
    .param p2, "top"    # F
...
.method static synthetic lambda$static$0(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    .registers 4
...
.method static synthetic lambda$static$1(Landroid/graphics/RectF;Landroid/graphics/RectF;)Z
    .registers 3
    .param p0, "segmentBounds"    # Landroid/graphics/RectF;
    .param p1, "area"    # Landroid/graphics/RectF;
...
.method public draw(Landroid/graphics/Canvas;Ljava/util/List;Ljava/util/List;Landroid/graphics/Path;Landroid/graphics/Paint;I)V
    .registers 20
    .param p1, "canvas"    # Landroid/graphics/Canvas;
...
.method public drawBackground(Landroid/graphics/Canvas;II)V
    .registers 34
    .param p1, "canvas"    # Landroid/graphics/Canvas;
...
.method public drawWithoutText(Landroid/graphics/Canvas;Ljava/util/List;Ljava/util/List;Landroid/graphics/Path;Landroid/graphics/Paint;III)V
    .registers 13
    .param p1, "canvas"    # Landroid/graphics/Canvas;
    .param p4, "selectionPath"    # Landroid/graphics/Path;
    .param p5, "selectionPaint"    # Landroid/graphics/Paint;
    ...
    :try_end_4e
    .catchall {:try_start_13 .. :try_end_4e} :catchall_4f
...
.method public fillCharacterBounds(II[FI)V
    .registers 31
    .param p1, "start"    # I
    .param p2, "end"    # I
    .param p3, "bounds"    # [F
...
.method public getLineBottom(IZ)I
    .registers 5
    .param p1, "line"    # I
